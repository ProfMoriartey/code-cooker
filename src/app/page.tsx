    ...
    <main className="flex min-h-screen flex-col items-center bg-gray-50 text-gray-900">
      ...
      <header className="flex w-full items-center justify-between bg-white p-4 shadow-sm">
        ...
        <div className="flex items-center">
          <Image
            src="/cooker3.png" // Path to your logo image in the public directory
            alt="Code Cooker Logo"
            width={110} // Adjust width as needed
            height={50} // Adjust height as needed, Next.js Image requires width/height
      ...
      <div className="container flex flex-1 flex-col items-center justify-center gap-8 px-4 py-16 text-center">
        <h1 className="text-5xl leading-tight font-extrabold tracking-tight sm:text-[5rem]">
          Make it. Scan it. <span className="text-[#60A5FA]">Share it.</span>
        </h1>
        <p className="max-w-2xl text-lg text-gray-700">
          Easy free to use QR code generator
          <br className="hidden sm:block" />
          Create an account to generate and save your QR codes
        </p>
        ...
        <div className="mt-12 grid w-full max-w-4xl grid-cols-1 gap-8 md:grid-cols-3">
          ...
          <div className="flex flex-col items-center rounded-lg bg-white p-6 shadow-md transition-transform duration-300 hover:scale-105">
            <div className="mb-4 flex h-24 w-24 items-center justify-center rounded-full text-indigo-600">
              {/* Placeholder for Image */}
              <Image
                src="/account.png" // Placeholder image
                alt="Make an Account"
                width={96}
                height={96}
          ...
          {/* Card 2: Enter Data */}
          <div className="flex flex-col items-center rounded-lg bg-white p-6 shadow-md transition-transform duration-300 hover:scale-105">
            <div className="mb-4 flex h-24 w-24 items-center justify-center rounded-full text-green-600">
              {/* Placeholder for Image */}
              <Image
                src="/input.png" // Placeholder image
                alt="Enter Data"
                width={96}
                height={96}
                className="rounded-full"
          ...
          <div className="flex flex-col items-center rounded-lg bg-white p-6 shadow-md transition-transform duration-300 hover:scale-105">
            <div className="mb-4 flex h-24 w-24 items-center justify-center rounded-full text-purple-600">
              {/* Placeholder for Image */}
              <Image
                src="/share.png" // Placeholder image
